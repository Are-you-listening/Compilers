...
- [X] [Error Analysis: Syntax Errors](example_source_files/19_1_Syntax_Errors.c)
- [X] [Error Analysis: Semantic Errors (all Semantic error features)](example_source_files/20_1_Semantic_Errors.c)
- [X] [SymbolTable and Visualization of the symbol table](example_source_files/21_SymbolTable_and_Visualization.c)
- [X] [Singleline Comments](example_source_files/22_SingleLine_Comment.c)
- [X] [Multiline Comments](example_source_files/23_MultiLine_Comment.c)
- [X] [Original Code as Comments](example_source_files/24_Original_Code_Comment.c)
- [X] [Outputting to the standard output using printf](example_source_files/25_Printf.c)
- [X] [Typedefs](example_source_files/26_Typedefs.c)
- [X] ['if' and 'else' statements](example_source_files/27_If_Else.c)
- [X] [Loops: 'while' and 'for', also support keywords 'break' & 'continue'](example_source_files/28_Loops.c)
- [X] [Scoping: if-else, for, while, anonymous](example_source_files/29_Scoping.c)
- [X] [Switch statements: switch, break, case](example_source_files/30_Switch.c)
- [X] [Enumerations](example_source_files/31_Enumeration.c)
- [X] [Support Scopes in symbol Table](./example_source_files/32_suppport_scopes_in_symbol_table.c)
- [X] [Function scopes](./example_source_files/33_function_scopes.c)
- [X] [Local & Global variables](./example_source_files/34_local_and_global_variables.c)
- [X] [Functions: definitions; declarations; calling, recursive calls](./example_source_files/35_functions.c)
- [X] [Pre-processor: #define](./example_source_files/36_pre-processor_define.c)
- [X] [Pre-processor: #include](./example_source_files/37_pre-processor_include.c)
- [X] [Optimisations: no code after break, continue, or return](./example_source_files/38_optimisation.c)
- [X] [Arrays both simple & multidimensional arrays](./example_source_files/39_arrays.c)
- [X] [Array initialization using initializer list](./example_source_files/40_array_initialization.c)
- [X] [Operations on array elements](./example_source_files/41_operations_on_array_elements.c)
- [X] [Strings encoded as zero-terminated char-arrays (both supported as char str[size] and char* str)](./example_source_files/42_strings.c)
- [X] [printf and scanf](./example_source_files/43_printf_and_scanf.c)
- [X] [user Defined Structs](./example_source_files/44_user_defined_structs.c)

- [X] [Include Guards (mandatory because group of 4)](./example_source_files/45_include_guards.c)
- [X] [Unions (mandatory because group of 4)](./example_source_files/46_unions.c)
- [X] [Function Pointers (mandatory because group of 4)](./example_source_files/47_function_pointer.c)
...
- [X] [Const Casting](./example_source_files/48_const_casting.c)
- [X] [ControlFlow and visualization (Extra optional)](./example_source_files/49_cfg.c)
- [X] [Else If Statements](./example_source_files/49_cfg.c)
- [X] [Optimisation: Do not generate code for conditions that are always false](./example_source_files/50_remove_dead_conditions.c)
- [X] [Semantic Error: Check for all paths in a function body whether a return statement is present](./example_source_files/51_valid_conditional_return.c)
- [X] [Dynamic Arrays (stored on heap) (malloc, free, calloc, realloc)](./example_source_files/53_dynamic_allocation.c)
- [X] [Structs that contain other structs as a value](./example_source_files/52_struct_in_struct.c)
- [X] [Dynamic Allocation of Structs (store structs on heap) (support by also supporting sizeof function)](./example_source_files/53_dynamic_allocation.c)
- [X] [File reading using fgets (uses FILE* with fopen and fclose)](./example_source_files/54_file_io.c)
- [X] [File writing using fputs (uses FILE* with fopen and fclose)](./example_source_files/54_file_io.c)
- [X] [Dynamically allocated strings and character buffers (can be used for printf, fgets, fputs, ...)](./example_source_files/54_file_io.c)
