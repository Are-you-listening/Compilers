...
.75:
  ...
  %".77" = bitcast [3 x i8]* @".str.PS0" to i8*
  %".78" = alloca i32
  store i32 3, i32* %".78"
  %".80" = load i32, i32* %".78"
...
.95:
  %".96" = bitcast [3 x i8]* @".str.PS0" to i8*
  %".97" = alloca i32
  store i32 7, i32* %".97"
  %".99" = load i32, i32* %".97"
...
.103:
  ...
  ;  case 6 b = 6
  %".106" = bitcast [3 x i8]* @".str.PS0" to i8*
  %".107" = alloca i32
  store i32 6, i32* %".107"
...
.112:
  ...
  ;   case 2 b = 2
  %".115" = bitcast [3 x i8]* @".str.PS0" to i8*
  %".116" = alloca i32
  store i32 2, i32* %".116"
  ...
  br label %".121"
.121:
  %".122" = bitcast [3 x i8]* @".str.PS0" to i8*
  %".123" = alloca i32
  store i32 4, i32* %".123"
