...
.2:
  ...
  ; printf "%f '\n'" p
  %".52" = bitcast [8 x i8]* @".str.PS2" to i8*
  %".53" = alloca float
  ...
  ; printf "%f '\n'" p
  %".60" = bitcast [8 x i8]* @".str.PS2" to i8*
  %".61" = alloca float
  ...
  ; printf "a%fa '\n'" p
  %".68" = bitcast [10 x i8]* @".str.PS3" to i8*
  %".69" = alloca float
  ...
  ;  printf "%f" p
  %".78" = bitcast [3 x i8]* @".str.PS4" to i8*
  %".79" = alloca float
...
@".str.PS2" = internal constant [8 x i8] c"%f '\5cn'\00"
@".str.PS3" = internal constant [10 x i8] c"a%fa '\5cn'\00"
@".str.PS4" = internal constant [3 x i8] c"%f\00"