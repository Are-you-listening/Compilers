...
.2:
  ...
  %".31" = bitcast [3 x i8]* @".str.PS1" to i8*
  %".32" = alloca i32
  store i32 %".30", i32* %".32"
  %".34" = load i32, i32* %".32"
  ...
  ; printf "%d" * h
  %".58" = bitcast [3 x i8]* @".str.PS1" to i8*
  %".59" = alloca i32
  store i32 %".56", i32* %".59"
  %".61" = load i32, i32* %".59"
  ...
  %".73" = bitcast [3 x i8]* @".str.PS1" to i8*
  %".74" = alloca i32
  store i32 %".72", i32* %".74"
  %".76" = load i32, i32* %".74"
  ...
  %".86" = bitcast [3 x i8]* @".str.PS1" to i8*
  %".87" = alloca i32
  store i32 %".85", i32* %".87"
  %".89" = load i32, i32* %".87"
  ...
  ; printf "%c" l
  %".109" = bitcast [3 x i8]* @".str.PS0" to i8*
  %".110" = alloca i8
  store i8 %".107", i8* %".110"
  %".112" = load i8, i8* %".110"
  ...
  ; printf "%c" l
  %".120" = bitcast [3 x i8]* @".str.PS0" to i8*
  %".121" = alloca i8
  store i8 %".118", i8* %".121"
  %".123" = load i8, i8* %".121"
