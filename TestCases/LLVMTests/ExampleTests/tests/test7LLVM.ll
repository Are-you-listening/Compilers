...
.2:
  ...
  ;  printf "%d" b
  %".35" = bitcast [3 x i8]* @".str.PS0" to i8*
  %".36" = alloca i32
  store i32 %".33", i32* %".36"
  %".38" = load i32, i32* %".36"
  %".39" = call i32 (i8*, ...) @"printf"(i8* %".35", i32 %".38")
  %".40" = bitcast [3 x i8]* @".str.PS1" to i8*
  %".41" = alloca float
  ...
  %".54" = bitcast [3 x i8]* @".str.PS2" to i8*
  %".55" = alloca i8
  store i8 5, i8* %".55"
  %".57" = load i8, i8* %".55"
  ...
  ; printf "%c" e
  %".62" = bitcast [3 x i8]* @".str.PS2" to i8*
  %".63" = alloca i8
  store i8 %".60", i8* %".63"
  %".65" = load i8, i8* %".63"
  ...
  %".74" = bitcast [3 x i8]* @".str.PS2" to i8*
  %".75" = alloca i8
  store i8 %".73", i8* %".75"
  %".77" = load i8, i8* %".75"
