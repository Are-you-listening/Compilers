...
.103:
  %".104" = bitcast [3 x i8]* @".str.0" to i8*
  %".105" = alloca i32
  store i32 7, i32* %".105"
...
.117:
  %".118" = bitcast [3 x i8]* @".str.0" to i8*
  %".119" = alloca i32
  store i32 8, i32* %".119"
...
.134:
  br label %".135"
.135:
  %".136" = bitcast [3 x i8]* @".str.0" to i8*
  %".137" = alloca i32
...
.164:
  %".165" = bitcast [3 x i8]* @".str.0" to i8*
  %".166" = alloca i32
  store i32 2, i32* %".166"
...
.189:
  %".190" = bitcast [3 x i8]* @".str.0" to i8*
  %".191" = alloca i32
  store i32 4, i32* %".191"
...
.200:
  %".201" = bitcast [3 x i8]* @".str.0" to i8*
  %".202" = alloca i32
  store i32 5, i32* %".202"
...
.211:
  ...
  br label %".213"
.213:
  %".214" = bitcast [3 x i8]* @".str.0" to i8*
  %".215" = alloca i32
  store i32 6, i32* %".215"
...
.229:
  %".230" = bitcast [3 x i8]* @".str.0" to i8*
  %".231" = alloca i32
  store i32 7, i32* %".231"
...
.243:
  %".244" = bitcast [3 x i8]* @".str.0" to i8*
  %".245" = alloca i32
  store i32 8, i32* %".245"
...
.253:
  %".254" = bitcast [3 x i8]* @".str.0" to i8*
  %".255" = alloca i32
  store i32 9, i32* %".255"
...
.260:
  br label %".261"
.261:
  %".262" = bitcast [3 x i8]* @".str.0" to i8*
  %".263" = alloca i32
...
.279:
  %".280" = bitcast [3 x i8]* @".str.0" to i8*
  %".281" = alloca i32
  store i32 1, i32* %".281"
...
.302:
  %".303" = bitcast [3 x i8]* @".str.0" to i8*
  %".304" = alloca i32
  store i32 3, i32* %".304"
...
.315:
  %".316" = bitcast [3 x i8]* @".str.0" to i8*
  %".317" = alloca i32
  store i32 4, i32* %".317"
...
.326:
  %".327" = bitcast [3 x i8]* @".str.0" to i8*
  %".328" = alloca i32
  store i32 5, i32* %".328"
...
.337:
  ...
  br label %".339"
.339:
  %".340" = bitcast [3 x i8]* @".str.0" to i8*
  %".341" = alloca i32
  store i32 6, i32* %".341"
...
.355:
  %".356" = bitcast [3 x i8]* @".str.0" to i8*
  %".357" = alloca i32
  store i32 7, i32* %".357"
...
.369:
  %".370" = bitcast [3 x i8]* @".str.0" to i8*
  %".371" = alloca i32
  store i32 8, i32* %".371"
...
.379:
  %".380" = bitcast [3 x i8]* @".str.0" to i8*
  %".381" = alloca i32
  store i32 9, i32* %".381"
...
.386:
  br label %".387"
.387:
  %".388" = bitcast [3 x i8]* @".str.0" to i8*
  %".389" = alloca i32
...
.405:
  %".406" = bitcast [3 x i8]* @".str.0" to i8*
  %".407" = alloca i32
  store i32 1, i32* %".407"
...
.416:
  %".417" = bitcast [3 x i8]* @".str.0" to i8*
  %".418" = alloca i32
  store i32 2, i32* %".418"
...
.428:
  %".429" = bitcast [3 x i8]* @".str.0" to i8*
  %".430" = alloca i32
  store i32 3, i32* %".430"
...
.441:
  %".442" = bitcast [3 x i8]* @".str.0" to i8*
  %".443" = alloca i32
  store i32 4, i32* %".443"
...
.452:
  %".453" = bitcast [3 x i8]* @".str.0" to i8*
  %".454" = alloca i32
  store i32 5, i32* %".454"
...
.463:
  ...
  br label %".465"
.465:
  %".466" = bitcast [3 x i8]* @".str.0" to i8*
  %".467" = alloca i32
  store i32 6, i32* %".467"
...
.481:
  %".482" = bitcast [3 x i8]* @".str.0" to i8*
  %".483" = alloca i32
  store i32 7, i32* %".483"
...
.495:
  %".496" = bitcast [3 x i8]* @".str.0" to i8*
  %".497" = alloca i32
  store i32 8, i32* %".497"
...
.505:
  %".506" = bitcast [3 x i8]* @".str.0" to i8*
  %".507" = alloca i32
  store i32 9, i32* %".507"
...
.512:
  br label %".513"
.513:
  %".514" = bitcast [3 x i8]* @".str.0" to i8*
  %".515" = alloca i32
...
.531:
  %".532" = bitcast [3 x i8]* @".str.0" to i8*
  %".533" = alloca i32
  store i32 1, i32* %".533"
...
.542:
  %".543" = bitcast [3 x i8]* @".str.0" to i8*
  %".544" = alloca i32
  store i32 2, i32* %".544"
...
.554:
  %".555" = bitcast [3 x i8]* @".str.0" to i8*
  %".556" = alloca i32
  store i32 3, i32* %".556"
...
.567:
  %".568" = bitcast [3 x i8]* @".str.0" to i8*
  %".569" = alloca i32
  store i32 4, i32* %".569"
...
.578:
  %".579" = bitcast [3 x i8]* @".str.0" to i8*
  %".580" = alloca i32
  store i32 5, i32* %".580"
...
.589:
  ...
  br label %".591"
.591:
  %".592" = bitcast [3 x i8]* @".str.0" to i8*
  %".593" = alloca i32
  store i32 6, i32* %".593"
...
.607:
  %".608" = bitcast [3 x i8]* @".str.0" to i8*
  %".609" = alloca i32
  store i32 7, i32* %".609"
...
.621:
  %".622" = bitcast [3 x i8]* @".str.0" to i8*
  %".623" = alloca i32
  store i32 8, i32* %".623"
...
.631:
  %".632" = bitcast [3 x i8]* @".str.0" to i8*
  %".633" = alloca i32
  store i32 9, i32* %".633"
...
.638:
  br label %".639"
.639:
  %".640" = bitcast [3 x i8]* @".str.0" to i8*
  %".641" = alloca i32
