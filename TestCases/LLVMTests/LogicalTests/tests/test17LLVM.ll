...
.47:
  ...
  ; printf "%d" f
  %".55" = bitcast [3 x i8]* @".str.PS0" to i8*
  %".56" = alloca i32
  store i32 %".53", i32* %".56"
  %".58" = load i32, i32* %".56"
...
.91:
  ...
  ; printf "%d" h
  %".97" = bitcast [3 x i8]* @".str.PS0" to i8*
  %".98" = alloca i32
  store i32 %".95", i32* %".98"
  %".100" = load i32, i32* %".98"
...
.165:
  ...
  ; printf "%d" h
  %".171" = bitcast [3 x i8]* @".str.PS0" to i8*
  %".172" = alloca i32
...
.195:
  ...
  ; printf "%d" f
  %".203" = bitcast [3 x i8]* @".str.PS0" to i8*
  %".204" = alloca i32
...
.216:
  ...
  ; printf "%d" g
  %".222" = bitcast [3 x i8]* @".str.PS0" to i8*
  %".223" = alloca i32
...
.269:
  ...
  ; printf "%d" f
  %".277" = bitcast [3 x i8]* @".str.PS0" to i8*
  %".278" = alloca i32
...
.290:
  ...
  ; printf "%d" g
  %".296" = bitcast [3 x i8]* @".str.PS0" to i8*
  %".297" = alloca i32
...
.313:
  ...
  ; printf "%d" h
  %".319" = bitcast [3 x i8]* @".str.PS0" to i8*
  %".320" = alloca i32
