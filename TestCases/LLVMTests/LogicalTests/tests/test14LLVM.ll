...
.50:
  ...
  br label %".54"
.54:
  %".63" = phi  i1 [1, %".47"], [%".58", %".50"], [0, %".43"], [1, %".37"]
...
.111:
  ...
  br label %".115"
.115:
  %".122" = phi  i1 [1, %".108"], [%".118", %".111"], [1, %".105"]
...
.148:
  ...
  br label %".152"
.152:
  %".159" = phi  i1 [1, %".145"], [1, %".142"], [%".155", %".148"]
...
.263:
  ...
  br label %".267"
.267:
  %".274" = phi  i1 [1, %".257"], [%".271", %".263"], [1, %".260"]
...
.302:
  ...
  br label %".306"
.306:
  %".313" = phi  i1 [1, %".296"], [%".309", %".302"], [1, %".299"]
...
.341:
  ...
  br label %".345"
.345:
  %".352" = phi  i1 [%".349", %".341"], [1, %".338"], [1, %".335"]
