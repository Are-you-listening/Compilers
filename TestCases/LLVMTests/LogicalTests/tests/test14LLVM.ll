...
.50:
  ...
  br label %".54"
.54:
  %".63" = phi  i1 [%".61", %".50"], [1, %".37"], [1, %".47"], [0, %".43"]
...
.185:
  ...
  br label %".189"
.189:
  %".196" = phi  i1 [%".193", %".185"], [1, %".182"], [1, %".179"]
...
.263:
  ...
  br label %".267"
.267:
  %".274" = phi  i1 [1, %".257"], [1, %".260"], [%".271", %".263"]
...
.302:
  ...
  br label %".306"
.306:
  %".313" = phi  i1 [%".310", %".302"], [1, %".299"], [1, %".296"]
...
.341:
  ...
  br label %".345"
.345:
  %".352" = phi  i1 [1, %".335"], [%".349", %".341"], [1, %".338"]
