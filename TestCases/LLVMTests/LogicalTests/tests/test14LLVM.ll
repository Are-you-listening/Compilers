...
.50:
  ...
  br label %".54"
.54:
  %".63" = phi  i1 [0, %".43"], [%".60", %".50"], [1, %".37"], [1, %".47"]
...
.185:
  ...
  br label %".189"
.189:
  %".196" = phi  i1 [1, %".182"], [%".192", %".185"], [1, %".179"]
...
.224:
  ...
  br label %".228"
.228:
  %".235" = phi  i1 [1, %".221"], [1, %".218"], [%".231", %".224"]
...
.263:
  ...
  br label %".267"
.267:
  %".274" = phi  i1 [%".272", %".263"], [1, %".260"], [1, %".257"]
...
.302:
  ...
  br label %".306"
.306:
  %".313" = phi  i1 [1, %".299"], [%".310", %".302"], [1, %".296"]
