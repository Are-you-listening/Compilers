...
.50:
  ...
  br label %".54"
.54:
  %".63" = phi  i1 [%".61", %".50"], [1, %".47"], [1, %".37"], [0, %".43"]
...
.148:
  ...
  br label %".152"
.152:
  %".159" = phi  i1 [1, %".142"], [1, %".145"], [%".157", %".148"]
...
.185:
  ...
  br label %".189"
.189:
  %".196" = phi  i1 [1, %".182"], [1, %".179"], [%".194", %".185"]
...
.263:
  ...
  br label %".267"
.267:
  %".274" = phi  i1 [1, %".260"], [%".270", %".263"], [1, %".257"]
...
.302:
  ...
  br label %".306"
.306:
  %".313" = phi  i1 [1, %".299"], [1, %".296"], [%".309", %".302"]
