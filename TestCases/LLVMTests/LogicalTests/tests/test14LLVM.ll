...
.50:
  ...
  br label %".55"
.55:
  %".56" = phi  i1 [1, %".47"], [1, %".37"], [0, %".43"], [%".54", %".50"]
...
.133:
  ...
  br label %".138"
.138:
  %".139" = phi  i1 [%".137", %".133"], [1, %".130"], [1, %".127"]
...
.165:
  ...
  br label %".170"
.170:
  %".171" = phi  i1 [1, %".162"], [1, %".159"], [%".169", %".165"]
...
.199:
  ...
  br label %".204"
.204:
  %".205" = phi  i1 [%".203", %".199"], [1, %".193"], [1, %".196"]
...
.267:
  ...
  br label %".272"
.272:
  %".273" = phi  i1 [%".271", %".267"], [1, %".261"], [1, %".264"]
