...
.50:
  ...
  br label %".54"
.54:
  %".63" = phi  i1 [1, %".47"], [0, %".43"], [%".61", %".50"], [1, %".37"]
...
.111:
  ...
  br label %".115"
.115:
  %".122" = phi  i1 [1, %".108"], [1, %".105"], [%".120", %".111"]
...
.148:
  ...
  br label %".152"
.152:
  %".159" = phi  i1 [%".156", %".148"], [1, %".145"], [1, %".142"]
...
.185:
  ...
  br label %".189"
.189:
  %".196" = phi  i1 [%".192", %".185"], [1, %".182"], [1, %".179"]
...
.263:
  ...
  br label %".267"
.267:
  %".274" = phi  i1 [%".270", %".263"], [1, %".260"], [1, %".257"]
