...
.50:
  ...
  br label %".54"
.54:
  %".63" = phi  i1 [%".60", %".50"], [1, %".37"], [1, %".47"], [0, %".43"]
...
.148:
  ...
  br label %".152"
.152:
  %".159" = phi  i1 [1, %".145"], [%".157", %".148"], [1, %".142"]
...
.224:
  ...
  br label %".228"
.228:
  %".235" = phi  i1 [1, %".218"], [%".231", %".224"], [1, %".221"]
...
.302:
  ...
  br label %".306"
.306:
  %".313" = phi  i1 [%".310", %".302"], [1, %".296"], [1, %".299"]
...
.341:
  ...
  br label %".345"
.345:
  %".352" = phi  i1 [%".350", %".341"], [1, %".338"], [1, %".335"]
