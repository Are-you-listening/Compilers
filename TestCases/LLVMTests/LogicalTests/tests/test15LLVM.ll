...
.167:
  ...
  br label %".172"
.172:
  %".173" = phi  i1 [1, %".164"], [%".171", %".167"], [1, %".161"]
...
.201:
  ...
  br label %".206"
.206:
  %".207" = phi  i1 [1, %".198"], [1, %".195"], [%".205", %".201"]
...
.235:
  ...
  br label %".240"
.240:
  %".241" = phi  i1 [1, %".232"], [1, %".229"], [%".239", %".235"]
...
.269:
  ...
  br label %".274"
.274:
  %".275" = phi  i1 [%".273", %".269"], [1, %".263"], [1, %".266"]
...
.303:
  ...
  br label %".308"
.308:
  %".309" = phi  i1 [1, %".300"], [%".307", %".303"], [1, %".297"]
