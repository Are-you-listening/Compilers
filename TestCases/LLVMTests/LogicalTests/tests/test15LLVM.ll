...
.135:
  ...
  br label %".140"
.140:
  %".141" = phi  i1 [%".139", %".135"], [1, %".129"], [1, %".132"]
...
.167:
  ...
  br label %".172"
.172:
  %".173" = phi  i1 [1, %".161"], [1, %".164"], [%".171", %".167"]
...
.201:
  ...
  br label %".206"
.206:
  %".207" = phi  i1 [1, %".195"], [1, %".198"], [%".205", %".201"]
...
.235:
  ...
  br label %".240"
.240:
  %".241" = phi  i1 [%".239", %".235"], [1, %".229"], [1, %".232"]
...
.269:
  ...
  br label %".274"
.274:
  %".275" = phi  i1 [1, %".266"], [1, %".263"], [%".273", %".269"]
...
.303:
  ...
  br label %".308"
.308:
  %".309" = phi  i1 [1, %".300"], [1, %".297"], [%".307", %".303"]
