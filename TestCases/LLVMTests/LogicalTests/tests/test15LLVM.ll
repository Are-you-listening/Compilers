...
.50:
  ...
  br label %".54"
.54:
  %".63" = phi  i1 [1, %".37"], [%".60", %".50"], [0, %".43"], [1, %".47"]
...
.111:
  ...
  br label %".115"
.115:
  %".122" = phi  i1 [%".119", %".111"], [1, %".105"], [1, %".108"]
...
.150:
  ...
  br label %".154"
.154:
  %".161" = phi  i1 [%".157", %".150"], [1, %".144"], [1, %".147"]
...
.187:
  ...
  br label %".191"
.191:
  %".198" = phi  i1 [%".195", %".187"], [1, %".181"], [1, %".184"]
...
.226:
  ...
  br label %".230"
.230:
  %".237" = phi  i1 [1, %".220"], [%".235", %".226"], [1, %".223"]
