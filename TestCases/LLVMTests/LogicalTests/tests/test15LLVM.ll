...
.50:
  ...
  br label %".54"
.54:
  %".63" = phi  i1 [%".61", %".50"], [1, %".37"], [0, %".43"], [1, %".47"]
...
.150:
  ...
  br label %".154"
.154:
  %".161" = phi  i1 [1, %".144"], [1, %".147"], [%".159", %".150"]
...
.187:
  ...
  br label %".191"
.191:
  %".198" = phi  i1 [1, %".184"], [1, %".181"], [%".195", %".187"]
...
.226:
  ...
  br label %".230"
.230:
  %".237" = phi  i1 [1, %".223"], [1, %".220"], [%".233", %".226"]
...
.343:
  ...
  br label %".347"
.347:
  %".354" = phi  i1 [1, %".340"], [%".350", %".343"], [1, %".337"]
