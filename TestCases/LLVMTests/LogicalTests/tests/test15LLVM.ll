...
.50:
  ...
  br label %".54"
.54:
  %".63" = phi  i1 [1, %".47"], [0, %".43"], [1, %".37"], [%".61", %".50"]
...
.111:
  ...
  br label %".115"
.115:
  %".122" = phi  i1 [1, %".108"], [%".120", %".111"], [1, %".105"]
...
.150:
  ...
  br label %".154"
.154:
  %".161" = phi  i1 [%".158", %".150"], [1, %".144"], [1, %".147"]
...
.187:
  ...
  br label %".191"
.191:
  %".198" = phi  i1 [1, %".181"], [1, %".184"], [%".195", %".187"]
...
.226:
  ...
  br label %".230"
.230:
  %".237" = phi  i1 [1, %".220"], [1, %".223"], [%".235", %".226"]
...
.265:
  ...
  br label %".269"
.269:
  %".276" = phi  i1 [1, %".262"], [%".274", %".265"], [1, %".259"]
...
.304:
  ...
  br label %".308"
.308:
  %".315" = phi  i1 [%".311", %".304"], [1, %".301"], [1, %".298"]
