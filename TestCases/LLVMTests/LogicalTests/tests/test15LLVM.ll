...
.141:
  ...
  ; printf "%d" f
  %".147" = bitcast [3 x i8]* @".str.PS0" to i8*
  %".148" = alloca i32
...
.173:
  ...
  ; printf "%d" f
  %".179" = bitcast [3 x i8]* @".str.PS0" to i8*
  %".180" = alloca i32
...
.207:
  ...
  ; printf "%d" f
  %".213" = bitcast [3 x i8]* @".str.PS0" to i8*
  %".214" = alloca i32
...
.241:
  ...
  ; printf "%d" f
  %".247" = bitcast [3 x i8]* @".str.PS0" to i8*
  %".248" = alloca i32
...
.309:
  ...
  ; printf "%d" f
  %".315" = bitcast [3 x i8]* @".str.PS0" to i8*
  %".316" = alloca i32
