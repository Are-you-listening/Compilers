...
.111:
  ...
  br label %".115"
.115:
  %".122" = phi  i1 [1, %".105"], [1, %".108"], [%".119", %".111"]
...
.150:
  ...
  br label %".154"
.154:
  %".161" = phi  i1 [1, %".147"], [%".157", %".150"], [1, %".144"]
...
.226:
  ...
  br label %".230"
.230:
  %".237" = phi  i1 [1, %".223"], [1, %".220"], [%".235", %".226"]
...
.265:
  ...
  br label %".269"
.269:
  %".276" = phi  i1 [1, %".259"], [%".274", %".265"], [1, %".262"]
...
.343:
  ...
  br label %".347"
.347:
  %".354" = phi  i1 [%".352", %".343"], [1, %".340"], [1, %".337"]
