...
.123:
  ...
  ; printf "%d" f
  %".131" = bitcast [3 x i8]* @".str.d" to i8*
  %".132" = alloca i32
...
.144:
  ...
  ; printf "%d" g
  %".150" = bitcast [3 x i8]* @".str.d" to i8*
  %".151" = alloca i32
...
.198:
  ...
  ; printf "%d" f
  %".206" = bitcast [3 x i8]* @".str.d" to i8*
  %".207" = alloca i32
...
.219:
  ...
  ; printf "%d" g
  %".225" = bitcast [3 x i8]* @".str.d" to i8*
  %".226" = alloca i32
...
.242:
  ...
  ; printf "%d" h
  %".248" = bitcast [3 x i8]* @".str.d" to i8*
  %".249" = alloca i32
...
.317:
  ...
  ; printf "%d" h
  %".323" = bitcast [3 x i8]* @".str.d" to i8*
  %".324" = alloca i32
